                    ...
                    <div class="tab-pane fade show active" id="dashboad" role="tabpanel">
                        <div class="myaccount-content">
                            ...
                            <div class="welcome">
                                ...
                                <p>Ngày đặt hàng: <strong>{{ $donHang->created_at->format('d-m-Y') }}</strong>
                                <p>Ghi chú nhận hàng: <strong>{{ $donHang->ghhi_chu }}</strong>
                                <p>Trạng thái đơn hàng: <strong>{{ $trangThaiDonHang[$donHang->trang_thai_don_hang] }}</strong>
                                <p>Trạng thái thanh toán: <strong>{{ $trangThaiThanhToan[$donHang->trang_thai_thanh_toan] }}</strong>
                                ...
                                <p>Tổng tiền đơn hàng: <strong>{{ number_format($donHang->tong_tien, 0, '', '.') }}đ</strong>
                            </div>
                        </div>
                    </div>
                </div>
