                ...
                <div class="checkout-billing-details-wrap">
                    ...
                    <div class="billing-form-wrap">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="single-input-item">
                                        <label for="name" class="required">Tên người đặt</label>
                                        <input type="text" name="ten_nguoi_nhan" placeholder="Nhập tên người nhận" value="{{ Auth::user()->name }}" />
                                ...
                                <div class="col-md-6">
                                    <div class="single-input-item">
                                        ...
                                        <input type="text" name="email_nguoi_nhan" placeholder="Email người nhận" value="{{ Auth::user()->email }}" />
                            ...
                            <div class="single-input-item">
                                ...
                                <textarea name="ghhi_chu" id="ghhi_chu" cols="30" rows="3" placeholder="Nhập ghi chú"></textarea>
                            </div>
